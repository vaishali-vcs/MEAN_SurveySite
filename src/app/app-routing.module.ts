...
{ path: 'survey/add-survey', component: AddSurveyComponent, canActivate: [AuthGuard] },
{ path: 'survey/edit-survey/:id', component: AddSurveyComponent, canActivate: [AuthGuard] },
